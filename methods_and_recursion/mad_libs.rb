...
puts "
A vacation is when you take a trip to some #{adj1} placewith your
 #{adj2} family. Usually you go to some placethat is near a/an
 #{noun1} or up on a/an #{noun2}.A good vacation place is one where
you can ride #{noun3}or play #{game} or go hunting for #{noun4}. I
like to spend my time #{verb1} or #{verb2}. When parents go on a
vacation, they spend their time eating three #{noun5} a day, and
fathers play golf, and motherssit around #{verb3}. Last summer,
my little brotherfell in a/an #{noun6} and got poison #{plant} all
over his #{part_of_the_body}. My family is going to go to (the)
#{place}, and I will practice #{verb4}. Parentsneed vacations more
than kids because parents are always very #{adj3} and because they
 have to work #{number} hours every day all year making enough #{noun7}
